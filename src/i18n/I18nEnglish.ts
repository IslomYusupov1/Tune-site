...
export const I18nEnglish: I18nSchema = {
    ...
    TITLE_ABOUT_PAGE_LIST_TITLE1_1: "Rapid online processes within 1-2 minutes",
    TITLE_ABOUT_PAGE_LIST_TITLE1_2: "Long-term processes for complex credit products",
    TITLE_ABOUT_PAGE_LIST_TITLE2: "Conveyors for retail and corporate lending",
    TITLE_ABOUT_PAGE_LIST_TITLE3: "Omnichannel is provided by business processes for both online and offline clients",
    TITLE_ABOUT_PAGE_LIST_TITLE3_1: "5 projects with conveyors have been successfully integrated with mobile banks from TUNE",
    TITLE_ABOUT_PAGE_LIST_TITLE3_2: "For online applications, we use face identification via MYID",
    TITLE_ABOUT_PAGE_LIST_TITLE4: "Scoring cards of the products are fully parameterized and managed by the risk department without involvement of the department or developers",
    TITLE_ABOUT_PAGE_LIST_TITLE5: "Communication with all external systems is supported via the TUNE BELT data exchange tire",
    TITLE_ABOUT_PAGE_LIST_TITLE5_1: "Usually 10 or more systems are involved to collect data about applicants",
    ...
    TITLE_BANK_PAGE_LIST_TITLE2_2: "12 in action and 2 in process retail mobile banking platforms",
    ...
    TITLE_BANK_PAGE_LIST_TITLE5: "Micro service architecture with minimal dependence on Core Banking System",
    TITLE_BANK_PAGE_LIST_TITLE6: "Successful integrations with 6 Core Banking System:",
    ...
    TITLE_EQUARING_PAGE_SUBTITLE_2: "1 project in process",
    ...
    //TURNKEY
    TITLE_TURNKEY_PAGE_TITLE1: "An example of on request and turnkey development",
    ...
    TITLE_TURNKEY_PAGE_TITLE3: "Sello Market the project started in February 2021 and launched in September 2021",
    ...
    TITLE_TURNKEY_PAGE_TITLE7: "After the launch of Sello Pay (payments and transfers) and Sello Logistics (door-to-door delivery of goods), starting in September 2023, the application has been updated as Sello SuperApp.",
