            ...
            <div className="h-full lg:w-3/4 2xl:w-10/12 md:mx-auto md:bg-black md:rounded-2xl lg:h-[70vh] 2xl:h-[90%] md:custom-container md:justify-center md:mx-auto md:flex">
                <div
                    ...
                    <div
                        ...
                        {!open &&
                            <h3 className="xl:text-[32px] 2xl:text-[42px] 3xl:text-[48px] leading-6 lg:mb-4 text-[23px]">{translate("TITLE_TURNKEY_PAGE_TITLE1")}</h3>}
                        {!open &&
                            <div className="text-[15px]">
                                ...
                                <ul className="max-w-[775px] xl:text-[18px] 2xl:text-[24px] text-[14px] md:text-[16px] leading-25 list-disc">{translate("TITLE_TURNKEY_PAGE_TITLE5")}:...<br/> <b
                        ...
                        {open && <div>
                            ...
                            <p className="max-w-[775px] xl:text-[18px] 2xl:text-[24px] 3xl:text-[28px] leading-25">{translate("TITLE_TURNKEY_PAGE_TITLE7")}<br/> <b
