                    ...
                    <div
                        ...
                        {!open &&
                            <div className="text-[15px]">
                                ...
                                <p className="max-w-[775px] xl:text-[18px] 2xl:text-[28px] text-[14px] md:text-[16px] leading-25 ">{translate("TITLE_TURNKEY_PAGE_TITLE4")}</p>
                                <ul className="max-w-[775px] xl:text-[18px] 2xl:text-[28px] text-[14px] md:text-[16px] leading-25 list-disc">{translate("TITLE_TURNKEY_PAGE_TITLE5")}:...<br/> <b
                                        className="text-[14px] xl:text-[18px] 2xl:text-[28px] md:text-[16px] text-[#007AFF] cursor-pointer"
