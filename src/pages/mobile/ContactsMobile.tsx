    ...
    return (
        <motion.div ref={ref}
            ...
            <div className="flex custom-container h-full mx-auto justify-center 2xl:gap-6 xl:gap-3 lg:gap-3 flex-col text-white w-full text-start font-light lg:mx-[100px] xl:mt-[50px] 2xl:mt-[25px] lg:mt-[50px] ">
                ...
                <h2 className="2xl:text-[42px] xl:text-[22px] lg:text-[18px] text-[23px] mt-5 font-medium">{translate("TITLE_CONTACT_PAGE_MAIN_TITLE_1")}</h2>
                <div className="flex flex-col mt-3">
                    <p className="2xl:text-[28px] xl:text-[16px] lg:text-[14px] text-[14px]">{translate("TITLE_CONTACT_PAGE_MAIN_TITLE_2")}:</p>
                    <a className="2xl:text-[36px] xl:text-[22px] lg:text-[20px] text-[18px] font-medium cursor-pointer" href="tel:+998911345326">+998 91 134-53-26</a>
                </div>
                <div className="flex flex-col mt-3">
                    <p className="2xl:text-[28px] xl:text-[18px] lg:text-[14px] text-[14px]">{translate("TITLE_CONTACT_PAGE_MAIN_TITLE_3")}:</p>
                    <a href="mailto:Info@TuneConsulting.net" className="2xl:text-[36px] xl:text-[22px] cursor-pointer lg:text-[20px] text-[18px] font-medium">Info@TuneConsulting.net</a>
                </div>
                <div className="flex flex-col mt-3">
                    <p className="2xl:text-[28px] xl:text-[16px] lg:text-[14px] text-[14px]">{translate("TITLE_CONTACT_PAGE_MAIN_TITLE_4")}:</p>
                    <h3 className="2xl:text-[36px] xl:text-[22px] lg:text-[20px] text-[18px] font-normal">{translate("TITLE_CONTACT_PAGE_MAIN_TITLE_5")}</h3>
                </div>
                            ...
                            <Form onSubmit={handleSubmit} className="z-50 hidden md:block">
                                <div className="flex flex-col 2xl:gap-4 md:gap-3 2xl:mt-10 w-2/4">
                                    <div>
                                        <Field type="text"
                                               name="name"
                                               className={`${errors.name && touched.name ? "border-red-600 focus:border-red-600" : ""} 2xl:text-[25px] bg-white outline-0 border text-gray-900 rounded-lg focus:ring-[#003ABC] focus:border-[#003ABC] block w-full p-4 2xl:p-8`}
                                               placeholder={translate("TITLE_CONTACT_PAGE_MAIN_TITLE_7")}
                                        />
                                    </div>
                                    <div className="flex  gap-4">
                                        <div className="w-full">
                                            <Field type="text"
                                                   name="email"
                                                   placeholder={translate("TITLE_CONTACT_PAGE_MAIN_TITLE_3")}
                                                   className={`${errors.email && touched.email ? "border-red-600 focus:border-red-600" : ""} 2xl:text-[25px] bg-white outline-0 border text-gray-900 rounded-lg focus:ring-[#003ABC] focus:border-[#003ABC] block w-full p-4 2xl:p-8`}/>
                                        </div>
                                        <div className="w-full">
                                            <Field type="text"
                                                   name="phone"
                                                   placeholder={translate("TITLE_CONTACT_PAGE_MAIN_TITLE_8")}
                                                   className={`${errors.phone && touched.phone ? "border-red-600 focus:border-red-600" : ""} 2xl:text-[25px] bg-white outline-0 border text-gray-900 rounded-lg focus:ring-[#003ABC] focus:border-[#003ABC] block w-full p-4 2xl:p-8`}/>
                                        </div>
                                    </div>
                                    <div>
                                        <Field type="text"
                                        ...
                                        >
                                            {({field}: any) => (
                                                <textarea
                                                    ...
                                                    onChange={(e) => setFieldValue("desc", e.target.value)}
                                                    placeholder={translate("TITLE_CONTACT_PAGE_MAIN_TITLE_9")}
                                                    className={`${errors.desc && touched.desc ? "border-red-600 focus:border-red-600" : ""} 2xl:text-[25px] bg-white outline-0 border text-gray-900 rounded-lg focus:ring-[#003ABC] focus:border-[#003ABC] block w-full p-4 2xl:p-8`}
                                                />
                                            )}
                                        </Field>
                                    </div>
                                    <button type="submit" disabled={loading}
                                            className="text-center bg-[#003ABC] 2xl:text-[25px] w-[200px] 2xl:p-7 2xl:w-[400px] text-white rounded-lg p-3">{translate("TITLE_CONTACT_PAGE_MAIN_TITLE_6")}
                                    </button>
                                </div>
                            </Form>
                        </>
