    ...
    return (
        <motion.div className="flex flex-col text-[#353535] lg:w-9/12 2xl:w-10/12 text-start font-light mx-[100px]">
            ...
            <motion.div variants={headerVariant} initial="hidden" animate="visible" exit="exit"
                ...
                <h3 className="2xl:text-[40px] lg:text-[32px] leading-10 mb-3">CRM и полная автоматизация процессов
                    фронт офиса</h3>
            ...
            <motion.div variants={footerVariant} initial="hidden" animate="visible" exit="exit"
                        className="flex flex-col text-start">
                <h3 className="2xl:text-[32px] lg:text-[26px] mt-6">Улучшение процессов в одном проекте ДО и ПОСЛЕ</h3>
                <div className="flex flex-col">
                    ...
                    <motion.div animate={{ width: "75%" }} initial={{ width: 0 }} transition={{ duration: 1, delay: 1.02}} className="border-b border-black" />
                    ...
                    <motion.div animate={{ width: "75%" }} initial={{ width: 0 }} transition={{ duration: 1, delay: 1.04}} className="border-b border-black" />
                    <div className="flex justify-between w-3/4 2xl:py-3 lg:py-2 ">
                    ...
                    <motion.div animate={{ width: "75%" }} initial={{ width: 0 }} transition={{ duration: 1, delay: 1.06}} className="border-b border-black" />
                    <div className="flex justify-between w-3/4 2xl:py-3 lg:py-2 ">
                    ...
                    <motion.div animate={{ width: "75%" }} initial={{ width: 0 }} transition={{ duration: 1, delay: 1.08}} className="border-b border-black" />
                    <div className="flex justify-between w-3/4 2xl:py-3 lg:py-2 ">
                    ...
                    <motion.div animate={{ width: "75%" }} initial={{ width: 0 }} transition={{ duration: 1, delay: 1.1}} className="border-b border-black" />
                    <div className="flex justify-between w-3/4 2xl:py-3 lg:py-2 ">
                        <p>Офлайн депозиты</p>
                        <div className="flex gap-8">
                            <span>20 min</span>
                    ...
                    <motion.div animate={{ width: "75%" }} initial={{ width: 0 }} transition={{ duration: 1, delay: 1.12}} className="border-b border-black" />
                    <div className="flex justify-between w-3/4 2xl:py-3 lg:py-2 ">
                    ...
                    <motion.div animate={{ width: "75%" }} initial={{ width: 0 }} transition={{ duration: 1, delay: 1.14}} className="border-b border-black" />
                    <div className="flex justify-between w-3/4 2xl:py-3 lg:py-2">
            ...
            <motion.div variants={imageVariant} initial="hidden" animate="visible" exit="exit"
                ...
                <motion.div animate={{ width: "100%" }} initial={{ width: 0 }} transition={{ duration: 1, delay: 1.25 }} className="border-b border-black" />
