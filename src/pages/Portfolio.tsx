...
function Portfolio() {
    return (
        <div className="flex flex-col 2xl:mt-[50px] lg:mt-[20px] gap-4 text-[#353535] lg:w-8/12 2xl:w-8/12 text-start font-light mx-[100px]">
            ...
            <motion.h3 variants={imageVariant} animate="visible" initial="hidden"
                       exit="exit"
                       className="2xl:text-[40px] lg:text-[32px]">Наша работа</motion.h3>
            <motion.div variants={contentVariant} animate="visible" initial="hidden"
                ...
                <div className="mx-2">
                    ...
                    <h3 className="2xl:text-[20px] lg:text-[20px] leading-7 mt-1">Созданы в 2009 году в Ташкенте в качестве «бутика» для
