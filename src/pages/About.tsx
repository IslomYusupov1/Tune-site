            ...
            <ContentLayout className="relative">
                <motion.div variants={containerVariants} initial="hidden" animate="visible" exit="exit"
                    ...
                    <motion.div
                        ...
                        initial="hidden"
                        animate="visible"
                        className="opacity-30 flex justify-end h-3/4 md:bg-transparent bg-white border-none text-end md:h-auto items-end w-full border border-transparent mt-5 rounded-2xl md:rounded-xl">
