    ...
    return (
        <motion.div
            ...
            <div className="w-screen container mx-auto z-50">
                ...
                {children}
                <motion.ul
                    className={`text-end flex flex-col lg:gap-3 text-[14px] z-50 xl:gap-4 xl:text-[16px] 2xl:gap-4 2xl:text-[19px] 3xl:text-[28px] 3xl:gap-8 items-end absolute container top-1/4 font-light ${bgImage === 2 ? "text-[#353535] font-light" : ""}`}>
                    <Link to={RoutesEnum.Main}>
                        <motion.li animate={{x: 10, opacity: 1}} initial={{x: 200, opacity: 0}}
                                   transition={{duration: 0.5, delay: 0.1, ease: "easeInOut"}}
                                   className={`${bgImage === 1 ? "hover:text-[#34C924] line-green" : "hover:text-[#003ABC] line-blue"} font-semibold cursor-pointer 
